...
local canvasConfig = require(canvas.config)
...
-- Streams
local playerOwnsAnyCanvasStream = objectsUtil.getObjectsStream(canvas)
...
local function setToolButtonHighlighted(button, highlighted)
	button.ImageColor3 = (highlighted and canvasConfig.activeToolHighlightColor or White)
end
...
local function claimCanvas(canvasInstance)
	...
	subscribe(toolButtonActiveStream, setToolButtonHighlighted)
